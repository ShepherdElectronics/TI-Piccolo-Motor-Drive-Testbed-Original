...
%   - Opens host model from C:\CourseDev\DMD
%
% CREATES:
%   SpeedRefRPM_effmap
%   DynoIqRef_A_effmap
...
figure('Name','Lab 1 Expanded Fixed Dwell RPM Command','Color','w');
...
figure('Name','Lab 1 Expanded Fixed Dwell Dyno Iq Command','Color','w');
...
hostModelName = 'mcb_pmsm_foc_host_model_dyno_f28069m_LAB_1';
