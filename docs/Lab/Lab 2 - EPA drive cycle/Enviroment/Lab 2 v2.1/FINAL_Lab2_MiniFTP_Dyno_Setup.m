...
%% ================================================================
%  6. OPEN LAB 2 HOST MODEL AND SET FTP-75 FROM-WORKSPACE BLOCKS
...
if isempty(modelFile)
    error(['Could not find ' modelName '.slx. Put it in:' newline ...
           '  C:\CourseDev\DualMotorDynoUsingC2000ProcessorsExample' newline ...
           'or' newline ...
           '  C:\CourseDev\DMD']);
end
