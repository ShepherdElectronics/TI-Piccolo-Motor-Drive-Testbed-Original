...
Public engineering release **v2.2**
...
- [Functional Requirements & Validation Report](docs/Dual_Motor_Dynamometer_FRD_v2.2.pdf)
- [Embedded Control, CAN & Characterization Report](docs/Embedded_Control_and_Characterization_Report_v2.2.pdf)
