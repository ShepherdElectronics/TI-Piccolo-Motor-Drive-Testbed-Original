...
Public engineering release **v1.9**
...
- [Functional Requirements & Validation Report](docs/Dual_Motor_Dynamometer_FRD_v1.9.pdf)
- [Embedded Control, CAN & Characterization Report](docs/Embedded_Control_and_Characterization_Report_v1.9.pdf)
