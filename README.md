...
Public engineering release **v1.6**
...
- [Functional Requirements & Validation Report](docs/Dual_Motor_Dynamometer_FRD_v1.6.pdf)
- [Embedded Control, CAN & Characterization Report](docs/Embedded_Control_CAN_and_Characterization_Report_v1.6.pdf)
